  ...
  {:then requests}
    <div class="my-5 flex flex-col">
      <div class="ml-10 flex flex-col">
        <div class="breadcrumbs text-sm">
          <ul>
            ...
            <li>
              <i class="fa-solid fa-circle-question mr-2"></i>{requests[id]
                .title}
            </li>
          </ul>
        </div>
        ...
        <div class="text-lg">Erstellt: {requests[id].created}</div>
        {#if requests[id].finished}
      ...
      <div class="mx-5  text-white">
        <Box margin="{false}" clazz="bg-purple-800">
          <div class="flex flex-col">
            <h2 class="text-2xl font-bold">
              {requests[id].author} - {requests[id].created}
            </h2>
            <p class="mt-2">{@html requests[id].content}</p>
            {#if requests[id].files.length > 0}
              <div class="divider"></div>
              <div class="text-2xl font-bold">Dateien:</div>
              <div class="mt-2 grid gap-5 md:grid-cols-3 lg:grid-cols-4">
                {#each requests[id].files as file}
        ...
        {#each requests[id].answers as answer}
  ...
  <div class="my-5 flex flex-col">
    ...
    <div class="mx-5  text-white">
      <Box margin="{false}" clazz="bg-purple-800">
        <div class="flex flex-col">
          <h2 class="text-2xl font-bold">
            {$tickets[id].expand.author.username} - {$tickets[id].created}
          </h2>
